...
class DataMaker():
    ...
    def __init__(self) -> None:
        ...
        self.data_path = os.path.join(self.project_path, "BBC News.csv")
        self.X_path = os.path.join(self.project_path, "BBC News_X.csv")
        self.y_path = os.path.join(self.project_path, "BBC News_y.csv")
        self.train_path = [os.path.join(self.project_path, "Train_BBC_X.csv"), os.path.join(
            self.project_path, "Train_BBC_y.csv")]
        self.test_path = [os.path.join(self.project_path, "Test_BBC_X.csv"), os.path.join(
            self.project_path, "Test_BBC_y.csv")]
        self.train_ready = os.path.join(self.project_path, "BBC News Train.csv")
        self.test_ready = os.path.join(self.project_path, "BBC News Test.csv")
